...
void Sound::LoadAllSound()
{
    ...
    handles_[CHARGE] = Load("Resource/Sounds/charge.mp3");
    handles_[FRUIT_FALL] = Load("Resource/Sounds/poi.mp3");

    handles_[ATTACK] = Load("Resource/Sounds/externals/attack.mp3");
    handles_[CHREERS] = Load("Resource/Sounds/externals/cheers!.mp3");
    handles_[PLAYER_HIT] = Load("Resource/Sounds/externals/playerHit.mp3");
    handles_[POUR_DRINK] = Load("Resource/Sounds/externals/pour_drink.mp3");
    handles_[YEAH] = Load("Resource/Sounds/yeah.mp3");
    handles_[GAME_OVER] = Load("Resource/Sounds/gameOver.mp3");
    handles_[BOUND] = Load("Resource/Sounds/externals/biyon.mp3");
    handles_[FULL_CHARGE] = Load("Resource/Sounds/externals/up.mp3");
    handles_[ALARM] = Load("Resource/Sounds/alarm.mp3");

    handles_[ANNOUNCE] = Load("Resource/Sounds/externals/announce.mp3");
    handles_[ANNOUNCE_CLOSE] = Load("Resource/Sounds/externals/announce_close.mp3");
    handles_[ANNOUNCE_FRUIT] = Load("Resource/Sounds/externals/announce_fruit.mp3");
