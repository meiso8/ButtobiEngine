...
void Texture::LoadAllTexture() {
    ...
    handle_[WHITE_1X1] = TextureManager::Load("Resource/Textures/white1x1.png");
    handle_[UV_CHECKER] = TextureManager::Load("Resource/Textures/uvChecker.png");
    handle_[NUMBERS] = TextureManager::Load("Resource/Textures/numbers.png");
